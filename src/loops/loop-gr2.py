...
def apply_n_draw(prod):
    global ITERATION
    applied_times = g.apply(prod)
    print(applied_times, ITERATION)
    draw(g, f"../draw/{ITERATION}-hyper.png")
    draw_without_hyper(g, f"../draw/{ITERATION}.png")
    ITERATION += 1
    return applied_times > 0
...
manual_rip_n_draw(5, 3)

apply_while([P8(), P2(), P1()])

manual_rip_n_draw(5.5, 3.25)

apply_while([P8(), P2(), P1()])

manual_rip_n_draw(5.75, 3.75)
