...
class TestP4Case1(unittest.TestCase):
    def setUp(self):
        self.p4 = P4()
        self.g = GraphTest()
        n1 = Node(0, 0, "n1")
    ...
    def test_stage0(self):
        draw(self.g, "draw/test4-case1-stage0.png")
    ...
    def test_stage1(self):
        applied = self.g.apply(self.p4)
        draw(self.g, "draw/test4-case1-stage1.png")
...
class TestP4Case2(unittest.TestCase):
    def setUp(self):
        self.p4 = P4()
        self.g = GraphTest()
        n0 = Node(0, 0, "n0")
        ...
        n9 = Node(1, 0.5, "n9")
        n10 = Node(1, 0, "n10")
        n11 = Node(0.75, 0.5, "n11", hanging=True)
        ...
        for n in [n0, n1, n2, n3, n4, n5, n6, n7, n9, n10, n11, n13, n14, n15, n16, n19, n21, n22, n23, n24]:
            self.g.add_node(n)
        ...
        self.g.add_edge(HyperEdge((n23, n6), "E", boundary=True))
        self.g.add_edge(HyperEdge((n3, n15), "E"))
        self.g.add_edge(HyperEdge((n24, n7), "E"))
        self.g.add_edge(HyperEdge((n1, n13, n15, n3), "Q", rip=True))
        self.g.add_edge(HyperEdge((n3, n15, n7, n24), "Q", rip=True))
        self.g.add_edge(HyperEdge((n24, n7, n6, n23), "Q"))
        


    def test_stage0(self):
        draw(self.g, "draw/test4-case2-stage0.png")
    ...
    def test_stage1(self):
        applied = self.g.apply(self.p4)
        draw(self.g, "draw/test4-case2-stage1.png")
        self.assertEqual(applied, 1)
...
class TestP4Case3(unittest.TestCase):
    def setUp(self):
        self.p4 = P4()
        self.g = GraphTest()
    ...
    def test_stage0(self):
        draw(self.g, "draw/test4-case3-stage0.png")
    ...
    def test_stage1(self):
        applied = self.g.apply(self.p4)
        draw(self.g, "draw/test4-case3-stage1.png")
...
class TestP4Case4(unittest.TestCase):
    def setUp(self):
        self.p4 = P4()
        self.g = GraphTest()
        n1 = Node(0, 0, "n1")
    ...
    def test_stage0(self):
        draw(self.g, "draw/test4-case4-stage0.png")
    ...
    def test_stage1(self):
        applied = self.g.apply(self.p4)
        draw(self.g, "draw/test4-case4-stage1.png")
        self.assertEqual(applied, 0)
